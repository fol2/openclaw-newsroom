...
Output requirements (Facebook style):
- Language: Traditional Chinese with Cantonese phrasing.
- Length: 450 to 900 Chinese characters (excluding URLs).
- Tone: clear, conversational, factual.
- Include 1 to 3 source URLs (each URL on its own line at the end).
